...
import eu.company.hosel.bsl.test.pages.contractCreation.ChooseProductPages;
import eu.company.hosel.bsl.test.pages.contractCreation.CreateContractPages;
import eu.company.hosel.bsl.test.pages.contractCreation.ViewContractPages;

public class ContractRegistrationStorySteps {
	HomePage homePage;
