...
public class ChooseProductPages extends PageObject {	
	...
	WebElementFacade salesroomId_C1;
	@FindBy(xpath = "//select[@data-better-uid='salesroom-id']")
	WebElementFacade salesroomId_PP;
	...
	public void chooseActiveSaleroom() {
		...
		if (BaseSs.isTestEnvi()) {
			...
			getSalesrooms.click();
			BaseSs.wait(1);
			salesroomId_C1.selectByValue("6104599200");
		} else {
			salesroomId_PP.waitUntilPresent();
			salesroomId_PP.selectByValue("8474");
		}
