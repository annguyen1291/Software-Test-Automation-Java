...
public class ViewContractPages extends PageObject {
	...
	public void verifyContract() {
		commonPage.waitForPresent(txtContractTitle, 60);
	...
	//Payment Channels
	@FindBy(xpath = "//a[@data-better-uid='contract-detail-tabbed-panel:tabs-container:contract-detail-payment-channels-tab-panel-tab-link']")
	WebElementFacade paymentChannelsTab;
	@FindBy(xpath = "//a[@data-uid='contract-detail-tabbed-panel:contract-detail-tabbed-panel:contract-detail-repayment-channel-panel:contract-detail-repayment-tab-buttons-panel:show-installment-schedule']")
	WebElementFacade installmentSchedule;
	@FindBy(xpath = "//div[@data-uid='installments:installment:body:1:2']/span")
	WebElementFacade txtInstallmentAmount;
	@FindBy(xpath = "//span[@data-uid='installment-schedule-detail-panel:contract-code']")
	WebElementFacade txtContractCodeP;
	@FindBy(xpath = "//a[@data-uid='home']")
	WebElementFacade homeIcon;
	
	public void getInstallmentInformation() {
		paymentChannelsTab.waitUntilPresent();
		paymentChannelsTab.sendKeys(Keys.ENTER);
		installmentSchedule.waitUntilPresent();
		installmentSchedule.sendKeys(Keys.ENTER);
		txtInstallmentAmount.waitUntilPresent();
		SM06_BSL_Payment.INSTALLMENT_AMOUNT = txtInstallmentAmount.getText().replaceAll("[^0-9]","");
		SM06_BSL_Payment.CONTRACT_NUMBER = txtContractCodeP.getText();
	}
}
